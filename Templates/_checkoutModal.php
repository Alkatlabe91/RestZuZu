        ...
        <div class="modal-body">
            <form action="Templates/_manageCart.php" method="post">
                <div class="form-group">
                    ...
                    <input class="form-control" id="address" name="address" placeholder="Straatnaam 1A" type="text" required minlength="3" maxlength="500">
                </div>
                <div class="form-group">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6 mb-0">
                        ...
                        <input type="text" class="form-control" id="zipcode" name="zipcode" placeholder="xxxxxxx" required minlength="[0-9]{7}" maxlength="87">                    
                    </div>
                </div>
                <div class="form-group">
