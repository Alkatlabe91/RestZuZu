...
echo '<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form method="get" action="/Rest/search.php" class="form-inline my-2 my-lg-0 mx-3">
        ...
        if($loggedin){
          echo '<ul class="navbar-nav mr-2">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="Templates/_logout.php">Logout</a>
              </div>
            </li>
          </ul>
          ...
          <button type="button" class="btn btn-primary mx-2"  data-toggle="modal" data-target="#signupModal">SignUp</button>';
        }
            
  echo '</div>
    </nav>';

    include 'Templates/_loginModal.php';
    include 'Templates/_signupModal.php';
