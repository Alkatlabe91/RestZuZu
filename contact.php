                  ...
                  <div class="col-lg-8">
                    <div class="contact-box p-4">
                      ...
                      <?php
                          ...
                          if($passRow=mysqli_fetch_assoc($passResult)){
                            $email = $passRow['email'];
                            $phone = $passRow['phone'];
                      ...
                      ?>
                      <form action="Templates/_manageContactUs.php" method="POST">
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                                <b><label for="email">Email:</label></b>
                                <input type="email" class="form-control" id="email" name="email" placeholder="Enter Your Email" required value="<?php if($loggedin){ echo $email ?> <?php } ?>">
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                      <span class="input-group-text" id="basic-addon">+31</span>
                                    </div>
                                    <input type="tel" class="form-control" id="phone" name="phone" aria-describedby="basic-addon" placeholder="Enter Your Phone Number" required pattern="[0-9]{9}" maxlength="9" value="<?php if($loggedin){ echo $phone ?><?php }?>">
                                </div>
                            </div>
                          </div>
                          <div class="col-lg-6">
                    ...
                    echo '<div class="col-lg-4 bg-image" style="background-image:url(img/contact.jpg)">
                          <div class="detail-box p-4">
                            ...
                            <div class="round-social light">
                              ...
                              <a href="" class="text-decoration-none text-white border border-white rounded-circle" ><i class="fab fa-github"></i></i></a>
                              <a href="" class="text-decoration-none text-white border border-white rounded-circle" ><i class="fab fa-youtube"></i></a>
                            </div>
                          </div>
                        </div>';
                  ?>
