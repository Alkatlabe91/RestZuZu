                    ...
                    <tbody>
                        <?php
                            ...
                            while($row=mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>
                                    <td>' .$Id. '</td>
                                    <td><img src="/rest/img/person-' .$Id. '.jpg" alt="image for this user" onError="this.src =\'/rest/img/profilePic.jpg\'" width="100px" height="100px"></td>
                                    <td>' .$username. '</td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <div class="row mx-auto" style="width:112px">
                                            ...
                                            if($Id == 1) {
                                                ...
                                                echo '<form action="Template/_userManage.php" method="POST">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="Template/_userManage.php" method="post">
        ...
        <div class="modal-body">
            ...
            <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
                <div class="form-group col-md-8">
                    <form action="Template/_userManage.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-4">
                    <img src="/rest/img/person-<?php echo $Id; ?>.jpg" alt="Profile Photo" width="100" height="100" onError="this.src ='/rest/img/profilePic.jpg'">
                    <form action="Template/_userManage.php" method="post">
                        <input type="hidden" id="userId" name="userId" value="<?php echo $Id; ?>">
