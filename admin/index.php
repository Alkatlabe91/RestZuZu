...
<head>
    ...
    <link rel = "icon" href ="/rest/img/logo.jpg" type = "image/x-icon">
    
    <link href='https://cdn.jsdelivr.net/npm/boxicons@2.0.5/css/boxicons.min.css' rel='stylesheet'>
    <link rel="stylesheet" href="publicForSideBar/css/styles.css">
...
<body id="body-pd" style="background: #80808045;">
    ...
    <script src="publicForSideBar/js/main.js"></script>
