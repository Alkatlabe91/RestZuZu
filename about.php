...
<html lang="en">
      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            <div class="carousel-background"><img src="public/img/slide/slide-1.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Welcome to <span>Sushi ZuZu</span></h2>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="public/img/slide/slide-2.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <!-- Slide 3 -->
          <div class="carousel-item">
            <div class="carousel-background"><img src="public/img/slide/slide-3.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h3>Welcome to <strong>Sushi ZuZu</strong></h3>
            <h3><strong>The Worldwide Leader in Sushi Delivery</strong></h3>
            <p class="font-italic">
          </div>
      ...
      <div class="container">
        ...
        <div class="row" style="padding-left: 228px;">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.1s">
            <div class="member">
              <img src="img/profilePic.jpg" class="img-fluid" alt="">
  ...
  <?php include 'Templates/_footer.php';?> 
    ...
    <script src="public/vendor/jquery-sticky/jquery.sticky.js"></script>
