        ...
        <div class="row">
            <div class="jumbotron p-3 mb-3" style="display: flex;justify-content: center;width: 28%;border-radius: 50px;margin: 0 auto;">
                <div class="user-info">
                    ...
                    <form action="Templates/_manageProfile.php" method="POST">
                    ...
                    <form action="Templates/_manageProfile.php" method="POST" enctype="multipart/form-data" style="margin-top: 7px;">
                    ...
                    <ul class="meta list list-unstyled" style="text-align:center;">
                        ...
                        <li class="my-2"><a href="Templates/_logout.php"><button class="btn btn-secondary" style="font-size: 15px;padding: 3px 8px;">Logout</button></a></li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group  col-md-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="tel" class="form-control" id="phone" name="phone" placeholder="Enter Your Phone Number" required pattern="[0-9]{9}" maxlength="9" value="<?php echo $phone ?>">
                                </div>
                            </div>
                            <div class="form-group  col-md-6">
